...
function createSupport() {
    ...
    // right leg
    cube = new THREE.Mesh(
        new THREE.CubeGeometry( 64, 334+52, 6 ), cubeMaterial ); cube.position.x = 0; // centered on origin along X
    cube.position.y = (334+52)/2;
...
function createHead() {
    ...
    cylinder = new THREE.Mesh(
        new THREE.CylinderGeometry( 80/2, 80/2, 70, 32 ), cylinderMaterial ); cylinder.position.x = 0;
